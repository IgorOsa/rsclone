    ...
    <div className="user-courses">
      ...
      <div className="card-group">
        <Link to="/english-lessons" className="card" style={{ maxWidth: "300px" }}>
          <img src="..." className="card-img-top" alt={t('English')} style={{ height: "150px", background: "#f78410" }} />
          <div className="card-body">
            <h5 className="card-title">{t('English')}</h5>
          </div>
        </Link>
      </div>
      <Link to="/english-lessons" className="btn btn-primary user-courses__all">All courses</Link>
    </div>
  );
}
