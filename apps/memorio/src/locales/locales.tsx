  ...
  resources: {
    en: {
      translation: {
        ...
        introDescription:
          'The key? A natural approach to learning real-life language. Jump in and give it a go!',
        ...
        coursesIntroDescription:
          'Preparing for a trip, moving to a new country or ooking to advance your career? Whatever your next adventure is, one of our courses will teach you all the real-life language you need to get out there and meet the world.',
    ...
    ru: {
      translation: {
        ...
        introDescription:
          'В чем секрет? Естественный подход к изучению современного языка. Присоединяйся!',
        introLink: 'Начать!',
        studentsTitle: 'Подготовили:',
        coursesIntroTitle: 'Учи языки онлайн вместе с Memorio',
        coursesIntroDescription:
          'Готовишься к путешествию, переезжаешь в новую страну или хочешь продвинуться по карьерной лестнице? Какой бы ни была твоя мотивация, с одним из наших курсов ты выучишь настоящий живой язык, на котором говорят в выбранной тобой стране.',
